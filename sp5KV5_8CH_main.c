 ...
 *
 * sp5KV5_8CH:
 * 2018-03-06: Version inicial tomando como base sp5KV5 R5.0.8 y adecuado a la
 * nueva placa de canales.
 *
 * V6.0.0:
 * - Elimino todo lo referente a consignas ( salidas )
 * - Idem TILT
 * - Idem TERMINAL ( Siempre prendida )
 * - Idem SLEEP
 * - idem PWRSAVE
 * - Idem PWRMODE ( Solo opera en modo continuo )
 * - Idem TIMERDIAL ( Solo opera en modo continuo )
 * - Idem ROAMING
 * - Idem EXIT_SERVICE
 * - La nueva placa de canales no tiene leds. Elimino de tkCTL.
 * - Elimino el diagnostico de leds.
 * - Elimino prender el analogpwr y el sensorpwr, read ADC, MCP1 y 2.
 * - PDT lo utilizo en IO para borrar los latches (CLD)
 * - GPRS: Solo proceso la senal de REDIAL. Elimino las otras.
 * - ELIMINO el modo SERVICE
 * - Introduzco los comandos de KILL (digital,data,gprs) para poder
 *   dar comandos de diagnostico sin interferir el funcionamiento normal.
 *
 * BUGS:
 * - En systemVars, mmin y mmax deben ser int16 para aceptar valores negativos y positivos.
 *
 * ========================================================================================
 * WATCHDOG:
